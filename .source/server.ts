...
import * as __fd_glob_8 from "../content/docs/nextjs/quick-started-nextjs.mdx?collection=docs"
import * as __fd_glob_7 from "../content/docs/nextjs/deploy.mdx?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"minecraft/meta.json": __fd_glob_0, "topup/meta.json": __fd_glob_1, "nextjs/meta.json": __fd_glob_2, "minecraft/bedrock/meta.json": __fd_glob_3, "minecraft/mods/meta.json": __fd_glob_4, }, {"index.mdx": __fd_glob_5, "minecraft/index.mdx": __fd_glob_6, "nextjs/deploy.mdx": __fd_glob_7, "nextjs/quick-started-nextjs.mdx": __fd_glob_8, "topup/truemoney-voucher.mdx": __fd_glob_9, "minecraft/bedrock/bds-setup-guide.mdx": __fd_glob_10, "minecraft/mods/waypoint-warp.mdx": __fd_glob_11, });