...
import Logo from '../../public/avatar.webp';
...
export const linkItems: LinkItemType[] = [
    ...
    {
        text: 'Modrinth',
        url: 'https://modrinth.com/user/ppekkungz',
        icon: <LayoutTemplate />,
        active: 'url',
    },
    {
    ...
    {
        type: 'icon',
        url: 'https://github.com/ppekkungz',
        label: 'github',
        text: 'Github',
        icon: (
    ...
    {
        type: 'icon',
        url: 'https://youtube.com/@ppekkungzchannel',
        label: 'youtube',
        text: 'Youtube',
        icon: (
